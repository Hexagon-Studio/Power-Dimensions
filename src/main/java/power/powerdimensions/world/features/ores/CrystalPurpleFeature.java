...
public class CrystalPurpleFeature extends OreFeature {
	public static CrystalPurpleFeature FEATURE = null;
	...
	private static class CrystalPurpleFeatureRuleTest extends RuleTest {
		static final CrystalPurpleFeatureRuleTest INSTANCE = new CrystalPurpleFeatureRuleTest();
		private static final com.mojang.serialization.Codec<CrystalPurpleFeatureRuleTest> CODEC = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		private static final RuleTestType<CrystalPurpleFeatureRuleTest> CUSTOM_MATCH = () -> CODEC;
