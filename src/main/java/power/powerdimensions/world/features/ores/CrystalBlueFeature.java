...
public class CrystalBlueFeature extends OreFeature {
	public static CrystalBlueFeature FEATURE = null;
	...
	private static class CrystalBlueFeatureRuleTest extends RuleTest {
		static final CrystalBlueFeatureRuleTest INSTANCE = new CrystalBlueFeatureRuleTest();
		private static final com.mojang.serialization.Codec<CrystalBlueFeatureRuleTest> CODEC = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		private static final RuleTestType<CrystalBlueFeatureRuleTest> CUSTOM_MATCH = () -> CODEC;
