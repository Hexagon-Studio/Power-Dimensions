...
public class CrystalLimeFeature extends OreFeature {
	public static CrystalLimeFeature FEATURE = null;
	...
	private static class CrystalLimeFeatureRuleTest extends RuleTest {
		static final CrystalLimeFeatureRuleTest INSTANCE = new CrystalLimeFeatureRuleTest();
		private static final com.mojang.serialization.Codec<CrystalLimeFeatureRuleTest> CODEC = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		private static final RuleTestType<CrystalLimeFeatureRuleTest> CUSTOM_MATCH = () -> CODEC;
