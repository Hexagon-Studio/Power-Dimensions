...
public class CrystallizedTeleporter implements ITeleporter {
	...
	public static void registerPointOfInterest(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.POI_TYPES, registerHelper -> {
			PoiType poiType = new PoiType(
					ImmutableSet.copyOf(PowerDimensionsModBlocks.CRYSTALLIZED_PORTAL.get().getStateDefinition().getPossibleStates()), 0, 1);
			registerHelper.register("crystallized_portal", poiType);
	...
	public Optional<BlockUtil.FoundRectangle> createPortal(BlockPos p_77667_, Direction.Axis p_77668_) {
		...
		BlockState blockstate = PowerDimensionsModBlocks.CRYSTALLIZED_PORTAL.get().defaultBlockState().setValue(NetherPortalBlock.AXIS, p_77668_);
