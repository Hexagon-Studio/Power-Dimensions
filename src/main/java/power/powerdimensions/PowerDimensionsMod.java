...
@Mod("power_dimensions")
public class PowerDimensionsMod {
	public static final Logger LOGGER = LogManager.getLogger(PowerDimensionsMod.class);
	public static final String MODID = "power_dimensions";
